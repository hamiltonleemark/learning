...
from notebooks.utils import show_prompt, stream_agent

load_dotenv(os.path.join(".env"), override=True)

from src.deep_agents_from_scratch.prompts import SUMMARIZE_WEB_SEARCH
...
from src.deep_agents_from_scratch.research_tools import tavily_search, think_tool, get_today_str
from src.deep_agents_from_scratch.task_tool import _create_task_tool
from src.deep_agents_from_scratch.todo_tools import write_todos, read_todos
...
def test_agent():
    ...
    agent = create_agent(model, all_tools, system_prompt=INSTRUCTIONS,
...
def test_deep_agent():
    ...
    agent = create_react_agent(tools=sub_agent_tools,
